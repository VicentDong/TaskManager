...
namespace TaskManagerServer
{
	...
	{
        private const string PrefixServerConfiguration = "TaskManagerServer";
        ...
        private const string DefaultServiceName = "TaskManagerQuartzServer";
        private const string DefaultServiceDisplayName = "TaskManager Quartz Server";
        private const string DefaultServiceDescription = "TaskManager Quartz Job Scheduling Server";
